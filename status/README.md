...
Note, there are other statuses we have not yet implemented ("NotStarted", "Running", "Canceled"). But it would probably be good for clients to handle "Canceled" as a terminal status along with "Succeeded" and "Failed".
