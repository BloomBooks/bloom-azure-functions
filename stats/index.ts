...
function getFromDateStr(req: HttpRequest): string | null | undefined {
  return req.query.from || (req.body && req.body.from);
}

function getToDateStr(req: HttpRequest): string | null | undefined {
  return req.query.to || (req.body && req.body.to);
}
