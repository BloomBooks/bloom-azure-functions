...
`;
        ...
        entry =
          entry +
          `    <link rel="http://opds-spec.org/acquisition/open-access" href="https://dev.bloomlibrary.org/readBook/${book.objectId}" type="application/bloomd+html" title="Read Online" />`;
      }
      if (imageHref) {
        entry =
          entry +
