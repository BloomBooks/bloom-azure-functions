...
async function refreshMaterializedViews() {
  ...
  // We leave them normally set to the values for the `stats` user which is safer
  ...
  // for the silpgadmin user.
  process.env.PGUSER = process.env.PGUSER_silpgadmin;
  process.env.PGHOST = process.env.PGHOST_silpgadmin;
  process.env.PGPASSWORD = process.env.PGPASSWORD_silpgadmin;
  process.env.PGDATABASE = process.env.PGDATABASE_silpgadmin;
  process.env.PGPORT = process.env.PGPORT_silpgadmin;
